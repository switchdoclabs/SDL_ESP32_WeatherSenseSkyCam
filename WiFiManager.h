...
const char HTTP_SCRIPT[] PROGMEM          = "<script>function c(l){document.getElementById('s').value=l.innerText||l.textContent;document.getElementById('p').focus();}</script>";
const char HTTP_HEAD_END[] PROGMEM        = "</head><body><div style='text-align:left;display:inline-block;min-width:260px;'>";
//const char HTTP_PORTAL_OPTIONS[] PROGMEM = "SwitchDoc Labs WeatherSense SkyCam<BR><form action=\"wifi\" method=\"get\"><button>Configure WiFi</button></form><br/><form action=\"0wifi\" method=\"get\"><button>Configure WiFi (No Scan)</button></form>";
const char HTTP_PORTAL_OPTIONS[] PROGMEM = "SwitchDoc Labs WeatherSense SkyCam<BR><form action=\"wifi\" method=\"get\"><button>Configure WiFi</button></form>";
...
const char HTTP_FORM_START[] PROGMEM      = "<form method='get' action='wifisave'><input id='s' name='s' length=32 placeholder='WiFi SSID'> WiFi Name<br/><input id='p' name='p' length=64 placeholder='WiFi password'>WiFi Password<br/><br/><input id='q' name='q' length=64 placeholder='IP Address'>MQTT Raspberry Pi IP Address<br/><br/><input id='r' name='r' length=64 placeholder='1883'>MQTT Port Number<br/><br/>";
...
const char HTTP_SCAN_LINK[] PROGMEM       = "<br/><div class=\"c\"><a href=\"/wifi\">Scan</a></div>";
const char HTTP_SAVED[] PROGMEM           = "<div>Credentials Saved<br />Trying to connect SkyCam to network.<br />If it fails, reconnect to 192.168.4.1 and repeat the procedure to try again</div>";
const char HTTP_END[] PROGMEM             = "</div></body></html>";
